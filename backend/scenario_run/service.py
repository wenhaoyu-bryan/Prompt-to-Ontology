...
GOLDEN_DEMO_STEPS = [
    ...
    ScenarioStep(
        ...
        description="Open Analyst Agent and ask: 我应该喂我的猫吃什么？",
        description_zh="打开分析智能体，询问：我应该喂我的猫吃什么？",
        route="/agent",
    ...
    ScenarioStep(
        ...
        title_zh="提交建议到审核队列",
        description="Click Submit to Review in Analyst Agent.",
        description_zh="在分析智能体中点击提交到审核。",
        route="/agent",
        action_type=ActionType.MANUAL,
